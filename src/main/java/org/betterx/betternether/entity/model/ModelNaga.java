...
public class ModelNaga extends EntityModel<ModelNaga.NagaRenderState> {
    ...
    public void setupAnim(NagaRenderState state) {
        ...
        if (state.rollTooBig) {
            ...
            if (state.visuallySwimming) {
                this.head.xRot = this.lerpAngle(this.head.xRot, -0.7853982F, state.swimAmount);
            } else {
        ...
        double speed = state.movingOnGround ? 6 : 0.5;
        maxAngle = this.lerpAngle(maxAngle, speed > 1 ? 0.1F : 0.5F, 0.03F);
        double animation = state.ageInTicks * speed / 20;
    ...
    public static class NagaRenderState extends LivingEntityRenderState {
        public float swimAmount;
        public boolean rollTooBig;
        public boolean visuallySwimming;
        public boolean movingOnGround;
    }
}
