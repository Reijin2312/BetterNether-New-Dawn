...
public class NetherBlocks {
    ...
    // Willow //
            ...
            PALE_GLOOMGRASS = registerBlock("pale_gloomgrass", new BlockNetherGrass.BoneGrass());
            GLOOMGRASS = registerBlock("gloomgrass", new BlockNetherGrass.BoneGrass());
            GLOOMSCULK_VINE = registerBlock("gloomsculk_vine", new BlockBlackVine());
